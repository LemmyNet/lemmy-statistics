...
- `instances/joinlemmy.json.gz`: Limited output for the instance list, instances with less than 5 monthly users and some data fields are filtered out ([details](https://github.com/LemmyNet/lemmy-stats-crawler/blob/main/src/aggregate.rs#L52))
- `instances/minimal.json.gz`: Only the statistics, for use in graphs
